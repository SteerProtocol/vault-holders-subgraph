...
export class Factory__getVaultByStrategyAndIndexResultValue0Struct extends ethereum.Tuple {
  get state(): i32 {
    return this[0].toI32();
  }
...
export class Factory__getVaultDetailsResultValue0Struct extends ethereum.Tuple {
  get state(): i32 {
    return this[0].toI32();
  }
...
export class Factory extends ethereum.SmartContract {
  ...
  getVaultByStrategyAndIndex(
    _tokenId: BigInt,
    _vaultId: BigInt
  ): Factory__getVaultByStrategyAndIndexResultValue0Struct {
    let result = super.call(
      "getVaultByStrategyAndIndex",
    ...
    return changetype<Factory__getVaultByStrategyAndIndexResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      changetype<Factory__getVaultByStrategyAndIndexResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getVaultDetails(
    _address: Address
  ): Factory__getVaultDetailsResultValue0Struct {
    let result = super.call(
      "getVaultDetails",
    ...
    return changetype<Factory__getVaultDetailsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getVaultDetails(
    _address: Address
  ): ethereum.CallResult<Factory__getVaultDetailsResultValue0Struct> {
    let result = super.tryCall(
      "getVaultDetails",
      "getVaultDetails(address):((uint8,uint256,uint256,string,address,string))",
      [ethereum.Value.fromAddress(_address)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Factory__getVaultDetailsResultValue0Struct>(value[0].toTuple())
    );
  }
